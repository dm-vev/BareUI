// BareUI built-in low-res ASCII font (5x7), optimized for readability
#ifndef BAREUI_FONT_LORES5X7_H
#define BAREUI_FONT_LORES5X7_H

#include <stdint.h>

static const uint8_t bareui_lores5x7_table[95][5] = {
