...
## Структура
- `include/ui_core.h` и `src/ui_core.c` — потокобезопасный контекст, framebuffer, очереди событий (сенсор, клавиатура), рисование прямоугольников и текст через шрифт BareUI, API управления шрифтами и событиями.
